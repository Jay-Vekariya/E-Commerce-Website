...
function NavBar() {
  ...
  return (
    <main className="min-w-[500px]">
      <nav className="flex w-full justify-between bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white">
        <div className="flex w-full flex-row justify-between p-3 md:px-20">
          {" "}
          {/* Changed class to flex for proper alignment */}
          <div className="items-cente flex w-full justify-between space-x-4 p-3">
            {" "}
            {/* Added flex and space-x for spacing */}
            ...
            <li className="flex items-center space-x-4">
              {" "}
              {/* Added flex, items-center, and space-x for spacing */}
              {!toggleButton &&
                isAuthenticated /* Simplified conditional rendering */ && (
                  <img
                    src={user.picture}
                    alt={user.name}
        ...
        <ul
          ...
          } absolute left-0 top-[64px] w-full flex-col items-center bg-white bg-opacity-90 bg-gradient-to-r  from-indigo-500 via-purple-500 to-pink-500 p-3 py-2 text-center text-white shadow-lg md:px-20 lg:static lg:flex lg:w-auto lg:flex-row lg:items-center lg:space-x-14`}
        >
          {" "}
          {/* Improved responsive menu classes */}
          ...
          <li>
            <NavLink to="/addtocart" className="relative text-3xl">
              {" "}
              {/* Added relative class for notification positioning */}
              &#128722;
              {isNotification > 0 && (
